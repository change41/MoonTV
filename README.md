...
```bash
# 拉取预构建镜像
 docker pull registry.cn-hangzhou.aliyuncs.com/change_lee/moontv:[镜像版本号]

# 运行容器
# -d: 后台运行  -p: 映射端口 3000 -> 3000
docker run -d --name moontv -p 3000:3000 --env PASSWORD=your_password registry.cn-hangzhou.aliyuncs.com/change_lee/moontv:[镜像版本号]
```
...
services:
  moontv:
    image: registry.cn-hangzhou.aliyuncs.com/change_lee/moontv:[镜像版本号]
